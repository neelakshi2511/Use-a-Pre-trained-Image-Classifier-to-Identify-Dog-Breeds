...
#                                                                             
# PROGRAMMER: Neelakshi 
# DATE CREATED: 09/07/23                                 
# REVISED DATE: 09/07/23
...
def get_pet_labels(image_dir):
    ...
    for idx in range(0, len(in_files), 1):
       ...
       if in_files[idx][0] != ".":
           ...
           file_name_words = in_files[idx].split('_')
           pet_label_words = [word for word in file_name_words if word.isalpha()] 
           pet_label = ' '.join(pet_label_words)
